...
package com.blackview.base.download
...
//            Uri apkUri = FileProvider.getUriForFile(context, "你的包名", file);
            ...
            val authroty = "com.blackview.tsales_android" + ".fileprovider" //BuildConfig.APPLICATION_ID
    ...
    fun install(context: Context?, apkPath: String) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            //provider authorities
//            Uri apkUri = FileProvider.getUriForFile(context, "com.blackview.tsales_android.fileprovider", file);
            //Granting Temporary Permissions to a URI
            intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION)
        } else {
