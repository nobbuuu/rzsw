package com.blackview.base.common.ui
...
import com.blackview.base.common.ui.config.ActivityConfig
import com.blackview.base.dialog.LoadingDialog
import com.blackview.base.event.Message
import com.blackview.base.kt.ktToastShowInBottom
import com.blackview.base.utils.AudioPlayerManger
import com.blackview.base.utils.TxkToastUtil
...
//        BarUtils.setStatusBarLightMode(this, true)
    ...
    open fun initStateBar(
        @ColorInt stateBarColor: Int = ColorUtils.getColor(R.color.transparent),
    ...
    fun initTitleBar(
        ...
        titleBar?.let {
            titleBar.setBackgroundResource(R.color.page_bg)
            titleBar.titleView.setTextColor(ColorUtils.getColor(R.color.main_text_color))
            titleBar.leftIcon = ContextCompat.getDrawable(
                this,
                if (isWhileIcon) R.mipmap.ic_back_white else R.mipmap.ic_back
            )
    ...
    private fun createViewModel(type: Type) {
        ...
        viewModel = ViewModelProvider(viewModelStore, MVVMConfig.getConfig().viewModelFactory)
            .get(tClass) as VM
    }
