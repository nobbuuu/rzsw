...
object ThreeParty {
    ...
    // utils 集合了大量常用的工具
    const val blankj = "com.blankj:utilcodex:1.30.4"
    ...
    const val RWidgetHelper = "com.ruffian.library:RWidgetHelper-AndroidX:0.0.9"
    ...
    const val XRecyclerView = "com.github.HHotHeart:XRecyclerViewDivider:1.0.1"
    ...
    const val netty = "io.netty:netty-all:4.1.51.Final"
    const val dateFormat = "org.apache.logging.log4j:log4j-core:2.20.0"
    ...
    object Tencent {
        ...
        const val Mmkv = "com.tencent:mmkv:1.3.2"
