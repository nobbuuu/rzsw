...
class OrganAdapter : BaseQuickAdapter<OrganBean, AnimBaseViewHolder>(R.layout.item_body_organ) {
    ...
    override fun onCreateDefViewHolder(parent: ViewGroup, viewType: Int): AnimBaseViewHolder {
        return AnimBaseViewHolder(
            LayoutInflater.from(context).inflate(R.layout.item_body_organ, parent, false)
        )
    }
