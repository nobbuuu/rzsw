...
class ExerciseBedRoomFiveFragment : BaseVoiceAgainFragment<StudyExerciseViewModel, FragmentExerciseBedroomFiveBinding>() {
    fun getToggleViews(): List<ToggleImageView> {
        return listOf(mBinding.step5Iv, mBinding.step4Iv, mBinding.step3Iv, mBinding.step1Iv)
    }

    fun getForewordRaw(): Int {
        return R.raw.l252dr
    }

    fun getContentRaw(): IntArray {
        return intArrayOf(R.raw.l252q1, R.raw.l252q2, R.raw.l252q3, R.raw.l252q4)
    }

    fun updateStar(star: Int) {
