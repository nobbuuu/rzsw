...
class StudySchoolThreeFragment :
    BaseStudyFragment<StudyExerciseViewModel, FragmentStudySchoolThreeBinding>() {
    ...
    override fun getContentRaw(): IntArray {
        return intArrayOf(R.raw.at_school_scissors, R.raw.at_school_paint, R.raw.at_school_glue, R.raw.at_school_craft_knife)
    }
