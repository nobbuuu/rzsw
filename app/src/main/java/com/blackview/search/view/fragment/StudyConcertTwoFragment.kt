...
class StudyConcertTwoFragment :
    BaseStudyFragment<StudyExerciseViewModel, FragmentStudyConcertTwoBinding>() {
    ...
    override fun getContentRaw(): IntArray {
        return intArrayOf(R.raw.music_concert_harmonica, R.raw.music_concert_trumpet, R.raw.music_concert_saxophane, R.raw.music_concert_trombone)
    }
