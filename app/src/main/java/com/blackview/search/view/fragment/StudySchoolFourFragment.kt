...
import com.blackview.search.databinding.FragmentStudySchoolFourBinding
import com.blackview.search.databinding.FragmentStudySchoolOneBinding
import com.blackview.search.databinding.FragmentStudySchoolThreeBinding
...
class StudySchoolFourFragment :
    BaseStudyFragment<StudyExerciseViewModel, FragmentStudySchoolFourBinding>() {
    ...
    override fun getContentRaw(): IntArray {
        return intArrayOf(
            R.raw.at_school_ruler,
            R.raw.at_school_eraser,
            R.raw.at_school_natebook,
            R.raw.at_school_pencil
        )
    }
