...
class ExerciseBathroomTwoFragment :
    BaseVoiceAgainFragment<StudyExerciseViewModel, FragmentExerciseBathroomTwoBinding>() {
    ...
    private val handleClick = View.OnClickListener { v ->
        ...
        when (v.id) {
            ...
            R.id.step2Iv, R.id.step4Iv,R.id.step5Iv,R.id.step6Iv -> {
                checkAnswer("shoe", v)
            }
        }
    }
    ...
    override fun onResume() {
        ...
        steps.add(Step(R.raw.l282q1, "socks", null))
        steps.add(Step(R.raw.l282q2, "shoe", null))
        clickAbleViews.forEach {
        ...
        shoeMap.put(mBinding.step4Iv, false)
        shoeMap.put(mBinding.step5Iv, false)
        shoeMap.put(mBinding.step6Iv, false)
        checkMap.put("socks", socksMap)
        checkMap.put("shoe", shoeMap)

        AudioPlayerManger.playRaw(R.raw.l282dr, object : IPlayCallBack {
            override fun onStart(index: Int) {
            }
