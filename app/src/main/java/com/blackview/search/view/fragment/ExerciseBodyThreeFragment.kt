...
class ExerciseBodyThreeFragment :
    BaseVoiceAgainFragment<StudyExerciseViewModel, FragmentExerciseBodyThreeBinding>() {
    ...
    override fun onResume() {
        ...
        steps.add(Step(R.raw.l206q1, "socks", null))
        steps.add(Step(R.raw.l206q2, "pants", null))
        steps.add(Step(R.raw.l206q3, "shoe", null))
        clickAbleViews.forEach {
        ...
        socksMap.put(mBinding.footIv, false)
        socksMap.put(mBinding.toeIv, false)
        shoeMap.put(mBinding.footIv, false)
        shoeMap.put(mBinding.toeIv, false)
        pantsMap.put(mBinding.legIv, false)
        pantsMap.put(mBinding.kneeIv, false)
        checkMap.put("socks", socksMap)
        checkMap.put("shoe", shoeMap)
        checkMap.put("pants", pantsMap)

        AudioPlayerManger.playRaw(R.raw.l206dr, object : IPlayCallBack {
            override fun onStart(index: Int) {
            }
