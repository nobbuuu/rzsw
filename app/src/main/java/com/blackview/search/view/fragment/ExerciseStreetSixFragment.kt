...
import com.blackview.search.databinding.FragmentExerciseStreetSixBinding
import com.blackview.search.databinding.FragmentExerciseStreetTwoBinding
import com.blackview.search.viewmodel.StudyExerciseViewModel
import com.blackview.search.widget.ToggleImageView

class ExerciseStreetSixFragment :
    BaseExerciseFragment<StudyExerciseViewModel, FragmentExerciseStreetSixBinding>() {

    override fun getToggleViews(): List<ToggleImageView> {
        return listOf(mBinding.step4Iv, mBinding.step7Iv, mBinding.step8Iv, mBinding.step3Iv)
    }
    ...
    override fun getContentRaw(): IntArray {
        return intArrayOf(R.raw.l312q1, R.raw.l312q2, R.raw.l312q3, R.raw.l312q4)
    }
