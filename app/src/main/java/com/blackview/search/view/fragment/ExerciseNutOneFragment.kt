...
class ExerciseNutOneFragment :
    BaseExerciseFragment<StudyExerciseViewModel, FragmentExerciseNutBinding>() {

    override fun getToggleViews(): List<ToggleImageView> {
        return listOf(mBinding.step15Iv, mBinding.step14Iv, mBinding.step11Iv, mBinding.step12Iv)
    }
    ...
    override fun getContentRaw(): IntArray {
        return intArrayOf(R.raw.l380q1, R.raw.l380q2, R.raw.l380q3, R.raw.l380q4)
    }
