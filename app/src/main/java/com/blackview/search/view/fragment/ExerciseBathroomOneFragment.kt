...
import com.blackview.search.databinding.FragmentExerciseBathroomOneBinding
...
class ExerciseBathroomOneFragment :
    BaseVoiceAgainFragment<StudyExerciseViewModel, FragmentExerciseBathroomOneBinding>() {
    ...
    override fun onResume() {
        ...
        steps.add(Step(R.raw.l280q1, "socks", null))
        steps.add(Step(R.raw.l280q2, "shoe", null))
        clickAbleViews.forEach {
        ...
        AudioPlayerManger.playRaw(R.raw.l280dr, object : IPlayCallBack {
            override fun onStart(index: Int) {
            }
